...
void LinkedList::bg_add(ListItem* newListItem)
{
...
void LinkedList::end_add(ListItem* newListItem)
{
...
void LinkedList::pos_add_bef(ListItem* newListItem, int pos)
{
	if(pos > size || pos < 1)   // ??
	{
		return;
...
void LinkedList::pos_add_aft(ListItem* newListItem, int pos)
{
	if(pos > size || pos < 1)
	{
		return;
