...
public:
	...
	void bg_add(ListItem*);					//add to begin of list
	void end_add(ListItem*);				//add to end of list
	void pos_add_bef(ListItem*, int);		//add after position pointed
	void pos_add_aft(ListItem*, int);		//add before position pointed
