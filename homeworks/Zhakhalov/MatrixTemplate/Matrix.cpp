...
template <typename T> Matrix<T>::Matrix(unsigned width, unsigned height)
{
	_mat = NULL;
...
template <typename T> Matrix<T>::Matrix(Matrix<T> &Src)
{
	_width = Src._width;
	_height = Src._height;
...
template <typename T> void Matrix<T>::Transpone()
{
...
template <typename T> void Matrix<T>::SetVal(T Val,unsigned X, unsigned Y)
{
...
template <typename T> unsigned Matrix<T>::Width() const
{
	return _width;
}

template <typename T> unsigned Matrix<T>::Height() const
{
	return _height;
}
